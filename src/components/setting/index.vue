<template>
  ...
  >
    <n-scrollbar>
      <n-drawer-content title="Config" closable class="wrapper">
        ...
        <n-divider dashed>Sidebar style</n-divider>
        <n-grid>
          <n-grid-item
        ...
        <n-divider dashed>Layout mode</n-divider>
        <n-grid>
          <n-grid-item
        ...
        <n-divider dashed>Menu setting</n-divider>
        <div class="setting-item-wrapper">
          <span style="width: 100px">Menu width</span>
        ...
        <n-divider dashed>Button</n-divider>
        <div class="setting-item-wrapper">
          <span>Fixed top search</span>
    ...
    setup() {
      ...
      function exampleClick(item: any) {
        if (store?.state.theme === 'dark') {
          message.error('Dark mode is not used')
          return
        }
        sideExampleList.forEach((it) => {
          it.checked = it === item
