  ...
  <n-el>
    <div class="flex login-container" v-if="!isMobileScreen">
      <div class="left">
        ...
        <div class="content-wrapper">
          ...
          <div class="title">ㅁㅇㅈ</div>
          <div class="sub-title">Vue3 + Vite2 + Typescript + Navie UI</div>
          <div class="flex-1 flex justify-center items-center ttppii"> 모이자 프로젝트 </div>
          <div class="bottom-wrapper">ㅁㅇㅈ {{ version }} · Made by profavor</div>
        </div>
      </div>
      <div class="right">
        <div class="form-wrapper">
          ...
          <div class="mt-4 my-width flex-sub">
            <div class="flex justify-between">
              <n-checkbox v-model:checked="autoLogin">자동 로그인</n-checkbox>
              <a :underline="false" type="primary">계정 찾기</a>
            </div>
          </div>
        </div>
        <div class="third-login">
          <n-divider dashed>다른 로그인</n-divider>
    ...
    <div v-else class="m-login-container">
      <div class="header">
        ...
        <div class="mt-4 text-lg font-bold text-white"> ㅁㅇㅈ </div>
      </div>
      <div class="content">
        <n-input round placeholder="userName" size="large" v-model:value="username">
          <template #prefix>
            <n-icon>
              <PhoneIcon />
            </n-icon>
        ...
        <div class="flex justify-between mt-4">
          <n-checkbox v-model:checked="autoLogin" color="#fff">자동 로그인</n-checkbox>
          <a class="text-white" type="primary">계정 찾기</a>
        </div>
      </div>
      <div class="footer">
        <n-divider>다른 로그인</n-divider>
